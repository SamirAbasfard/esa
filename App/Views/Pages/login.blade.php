...
@endphp
@section('content')
    <link rel="stylesheet" href="{{$my_link_url}}/resources/css/login.css">
    <link rel="stylesheet" href="{{$my_link_url}}/resources/css/fonts.css">
    <form style="font-family: BYekan,Calibri" method="post" class="form-signin text-center">
        <img class="mb-4" src="{{$my_link_url}}/resources/img/bootstrap-solid.svg" alt="" width="72" height="72">
